    ...
    return (
        <>
            <div value = {isbn} className="mobile:max-h-[212px] mobile:min-h-[212px] mobile:max-w-[105px] mobile:min-w-[105px] desktop:max-h-[300px] desktop:max-w-[200px] flex flex-col items-center relative m-2">
                ...
                {status === "En attente de validation" && <button className='text-[#FFF] bg-red-400 p-1 desktop:w-[160px] mobile:w-[105px] absolute desktop:bottom-[45px] mobile:bottom-[52px] rounded-b-lg mobile:text-xs desktop:text-base' value ={loanid} key={loanid} onClick={handleAcceptRequest} >Accepter la demande</button>}
